                        ...
                        <form>
                            <c:forEach items="${feed}" var="c">
                                <div class="feedback-content">
                                    ...
                                    <c:if test="${c.reply != ''}">
                                        <div class="media mt-4 ml-5" style="padding-left:50px;">
                                            <a class="pr-3" href="#"><img class="rounded-circle" alt="avt" style="width:40px;height:40px;" src="https://i.imgur.com/xELPaag.jpg"></a>
                                            <div class="media-body">
                                                <div class="row">
                                                    <div class="col-12 d-flex">
                                                        <h5>Admin</h5>
                ...
                <div class="row">
                    <div class="col-lg-8 offset-lg-2 text-center">
                        <div class="section-title">	
                            <h3><span class="orange-text">Related</span> Combos</h3>
