                ...
                <div class="container-fluid px-4">
                    <div class="row my-5">
                        <div class="row mb-3">
                            ...
                            <button class="btn btn-success px-3 py-1 col-sm-2"><a class="view-modal text-decoration-none text-white" href="add-product"><span><i class="fa-sharp fa-solid fa-plus"></i></span>&nbsp; Add a new product</a></button>
                        </div>
                            ...
                            <table class="table bg-white rounded shadow-sm  table-hover">
                                <thead>
                                    <tr>
                                        ...
                                        <th scope="col" style="font-size: 90%">Price</th>
                                        <th scope="col" style="font-size: 90%">Status</th>
                                        <th scope="col" style="font-size: 90%">Action</th>
                                    </tr>
                                </thead>
                                <tbody>
                                    <c:forEach items="${list}" var="c">
                                        <tr>
                                            ...
                                            <td>${c.status}</td>
                                            <td>
                                                <a href="update-product?id=${c.productID}" class="edit"><i class="view-modal fa-sharp fa-regular fa-pen-to-square  text-dark"></i></a> &nbsp;&nbsp;&nbsp;
                                                <a href="delete-product?id=${c.productID}" class="delete"><i class="fa-sharp fa-solid fa-trash  text-dark"></i></a>
                                            </td>
                                        </tr>
                                    </c:forEach>
