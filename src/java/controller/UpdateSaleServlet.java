...
public class UpdateSaleServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet UpdateSaleServlet</title>");            
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet UpdateSaleServlet at " + request.getContextPath() + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    }
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        Sale sale = new SaleDAO().getSaleByID(id);
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        new SaleDAO().updateSale(id, name, value, code, s_date, e_date);
        List<Sale> sList = new SaleDAO().getAllSales();
        request.setAttribute("sList", sList);
        request.getRequestDispatcher("admin-sale.jsp").forward(request, response);
